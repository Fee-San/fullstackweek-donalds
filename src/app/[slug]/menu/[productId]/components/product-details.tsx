...
const ProductDetails = ({ product }: ProductDetailsProps) => {
  ...
  return (
    <>
      <div className="relative z-50 mt-[-1.5rem] rounded-t-3xl p-5 flex-auto flex-col overflow-hidden">
        ...
        <Button className="w-full rounded-full" onClick={handleAddToCard}>
          Adicionar à sacola
        </Button>
      </div>
      <CartSheet />
